        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gray-800 p-5 rounded-lg">
            ...
            <p className="text-gray-300 mb-3">
              Use your preferred wallet (Sui or Ethereum) to interact with
              agreements secured on Sui.
            </p>
            <Link
              to="/token-bridge"
          ...
          <div className="bg-gray-800 p-5 rounded-lg">
            ...
            <p className="text-gray-300">
              Secure fund management with automated milestone-based payments and
              dispute resolution.
            </p>
          </div>
          <div className="bg-gray-800 p-5 rounded-lg">
            ...
            <p className="text-gray-300">
              Web2-friendly experience with zkLogin for new users alongside
              support for existing web3 wallets.
            </p>
          </div>
          <div className="bg-gray-800 p-5 rounded-lg">
            ...
            <p className="text-gray-300">
              Decentralized dispute resolution through Verifiable Credential
              NFTs (coming soon).
            </p>
          </div>
        </div>
