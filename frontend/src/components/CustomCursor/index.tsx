...
const CustomCursor: React.FC = () => {
  ...
  const [firstVisit, setFirstVisit] = useState<boolean>(false);  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const container = containerRef.current;    if (!cursor || !dot || !container) return;
    ...
    const interactiveElements = document.querySelectorAll('a, button, .cursor-pointer, [role="button"], input[type="submit"], input[type="button"], input[type="reset"], [onClick]');
    ...
    const refreshInterval = setInterval(() => {
      const newInteractiveElements = document.querySelectorAll('a, button, .cursor-pointer, [role="button"], input[type="submit"], input[type="button"], input[type="reset"], [onClick]');
